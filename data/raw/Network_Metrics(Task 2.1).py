...
if nx.is_connected(G):
    ...
    print(f"Average Shortest Path Length: {avg_shortest_path_length:.3f}")
     ...
     print(f"Network is disconnected. Largest component: {len(largest_cc)}/{G.number_of_nodes()} nodes")
     print("Diameter (largest component):", nx.diameter(G_main))
     print("Average shortest path length (largest component):", round(nx.average_shortest_path_length(G_main), 2))
