...
master_dataset = (
    lines.merge(utilities, on='Utility ID', how='left').merge(substations.add_prefix('Source '),left_on='Source Substation ID', right_on='Source Substation ID', how='left' ).merge(substations.add_prefix('Dest '),left_on='Destination Substation ID', right_on='Dest Substation ID', how='left'))
...
if no_data_loss:
    print(f'CONCLUSION: No data loss detected. All {len(lines)} lines preserved with complete joined data.')
else:
