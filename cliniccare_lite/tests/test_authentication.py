...
def create_test_user(app, username: str, password: str, role: str) -> None:
...
def test_dashboards_require_login(client):
    ...
    clinician_response = client.get("/clinician/dashboard")

    patient_response = client.get("/patient/dashboard")
...
def test_patient_login(app, client):
    ...
    create_test_user(app, "testpatient", "Patient123!", "patient")
...
def test_clinician_login(app, client):
    ...
    create_test_user(app, "testclinician", "Clinician123!", "clinician")
...
def test_wrong_password_does_not_login(app, client):
